...
class SpeechModel:
    ...
    def __init__(self, args):
        ...
        (NPU, GPU, or CPU) to be used for running the model, based on system availability.

        Args:
        - args: Argument parser object containing settings like whether to use CUDA (GPU) or NPU.
        """
        # Check if NPU is available and preferred
        if torch.npu.is_available():
            args.use_cuda = 1  # Use NPU as acceleration device
            args.use_npu = 1   # Flag to indicate NPU usage
